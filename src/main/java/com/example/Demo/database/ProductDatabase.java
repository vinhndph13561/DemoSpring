    ...
    CommandLineRunner initDatabase3(ProductRepository productRepository){
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                Product prodA = new Product("Dell Latitue",20,"dell.jpg",1500000.0,"Black","16 inches",1L);
                Product prodB = new Product("HP 5580",10,"hp.jpg",1700000.0,"Black","16 inches",2L);
